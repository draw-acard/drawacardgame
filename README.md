# Draw A Card Game
This is the source for the game logic and posting for the Draw A Card game in steemit. https://steemit.com/@drawacard

I call the functions directly with a external program that is in my server. The program runs every 24 hours or more if needed and functions with a database.
### GameLogicAndUpdate.js
```
